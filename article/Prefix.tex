...
\ColumnHook
\end{hscode}\resethooks
A parser for negation should recognize the symbol \text{\ttfamily \char96{}\char126{}\char96{}} and yield an unary operator token with the matching function. The same should be done for the symbol \text{\ttfamily \char39{}\char33{}\char39{}} and the factorial operation. This can be generalized into a parser for any unary operator.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{unaryOp}\mathbin{::}\Conid{Symbol}\to (\Conid{Number}\to \Conid{Number})\to \Conid{Parser}{}\<[E]%
\\
...
\column{8}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{infix}\;\mathrm{2}\mathbin{<|>}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}(\mathbin{<|>})\mathbin{::}\Conid{Parser}\to \Conid{Parser}\to \Conid{Parser}{}\<[E]%
\\
\>[B]{}\Varid{parserA}\mathbin{<|>}\Varid{parserB}\mathrel{=}\lambda \Varid{s}\to \mathbf{let}\;\Varid{result}\mathrel{=}\Varid{parserA}\;\Varid{s}\;\mathbf{in}\;\mathbf{case}\;\Varid{result}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
