...
\\
\>[B]{}\Varid{unaryOp}\;(\Varid{c}\mathbin{:}\Varid{s})\mid \Varid{c}\equiv \Varid{sFac}\mathrel{=}[\mskip1.5mu (\Conid{UnaryTk}\;\Varid{fact},\Varid{s})\mskip1.5mu]{}\<[E]%
\\
...
\\
\>[B]{}\Varid{tree}\;\Varid{p}\;\Varid{s}\mathrel{=}\mathbf{case}\;\Varid{p}\;\Varid{s}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}[\mskip1.5mu \mskip1.5mu]\to [\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}[\mskip1.5mu (\Varid{a},\Varid{s})\mskip1.5mu]\to [\mskip1.5mu (\Conid{Node}\;\Varid{a}\;\Conid{Nil}\;\Conid{Nil},\Varid{s})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{seqP}\mathbin{::}\Conid{Parser}\;(\Conid{Tree}\;\Varid{a})\to \Conid{Parser}\;(\Conid{Tree}\;\Varid{a})\to \Conid{Parser}\;(\Conid{Tree}\;\Varid{a}){}\<[E]%
\\
