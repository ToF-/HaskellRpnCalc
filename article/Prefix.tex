...
\>[B]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\mathbf{import}\;\Conid{\Conid{Data}.Char}\;(\Varid{isSpace},\Varid{isDigit}){}\<[E]%
\ColumnHook
...
Let's begin with some helper functions for our parser:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{trim}\mathbin{::}\Conid{String}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{trim}\mathrel{=}\Varid{dropWhile}\;\Varid{isSpace}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
